...
const PaintingsFilters: FC<PaintingsFiltersTypes> = ({authors, locations, paintings}) => {
    ...
    return (
      ...
      <select className={styles.paintingsFiltersSelect} name="authorId" id="author" onChange={handleInputChange}>
      ...
      <select className={styles.paintingsFiltersSelect} name="locationId" id="location" onChange={handleInputChange}>
      ...
      <select className={styles.paintingsFiltersSelect}  name="created" id="created" onChange={handleInputChange}>
